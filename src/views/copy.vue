 ...
 * @LastEditTime: 2025-03-24 20:26:41
 * @Description: 
 * @FilePath: \ytab-master\src\views\copy.vue
-->
<template>
    <!-- 登录弹窗 -->
    <a-drawer
      ...
      function createBox(content: string) {
        ...
        box.addEventListener("click", (event) => {
          if (content == "1x1") {
            ...
            // 1. 获取存储的数组
            let garids =
              JSON.parse(localStorage.getItem("home" as string)) || [];
            ...
            // 3. 重新存储数组
            localStorage.setItem("home", JSON.stringify(garids));
